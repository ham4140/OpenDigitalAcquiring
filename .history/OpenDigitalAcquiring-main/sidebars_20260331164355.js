  ...
  MerchantManagementSidebar: [
...

    {
      ...
      items: [
        ...
        { type: 'doc', id: 'RAAST/MMS/User Management/User-changepassword', label: 'Change/Forgot Login' },
        { type: 'doc', id: 'RAAST/MMS/User Management/User-invalid', label: 'User Approval from Backoffice' },
      ],
    },
