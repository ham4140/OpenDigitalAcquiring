...
themeConfig: {
    ...
    navbar: {
      ...
      items: [
        { to: '/docs/RAAST/MMS/Functional-specification/Bulk-merchant-onboarding', label: 'Merchant management', position: 'left' },
        { to: '/docs/RAAST/Merchant-portal/dashboard', label: 'Merchant portal', position: 'left' },
        { to: '/docs/hybrid/Merchant-app/Dashboard', label: 'Merchant app', position: 'left'},
      ],
    },
