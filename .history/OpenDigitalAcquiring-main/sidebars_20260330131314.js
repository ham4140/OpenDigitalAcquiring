...
module.exports = {
  MerchantAppSidebar: [
    // Directly show all docs and tables, no top-level category
    { type: 'doc', label: 'Introduction', id: 'hybrid/intro' },
    ...
    { type: 'doc', id: 'hybrid/Merchant-app/Onboarded-Merchant/Merchant-Registeration', label: 'Merchant Registeration (ETB)' },
    { type: 'doc', id: 'hybrid/Merchant-app/Onboarded-Merchant/Merchant-Login', label: 'Merchant Login (ETB)' },
